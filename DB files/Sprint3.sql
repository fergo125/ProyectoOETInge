...
--Nueva tabla para guardar cuando se usan varios métodos de pago al crear una factura
CREATE TABLE REGISTRO_FACTURAS_VENTA_METODOSPAGOVARIOS
(
  IDFACTURA       NUMBER(38)    PRIMARY KEY,
  IDMETODOPAGO    VARCHAR2(30)  PRIMARY KEY,
  PAGO            NUMBER(64)
);
