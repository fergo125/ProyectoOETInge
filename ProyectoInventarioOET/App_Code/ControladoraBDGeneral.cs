...
namespace ProyectoInventarioOET.App_Code
{
    ...
    public class ControladoraBDGeneral : ControladoraBD
    {
        ...
        public int consultarImpuesto()
        {
            ...
            String comandoSQL = "SELECT * FROM " + esquema + "GEN_GENERAL WHERE ROWNUM = 1";
        ...
        public DataTable consultarTipoCambio()
        {
            ...
            DataTable resultado = new DataTable();
            String comandoSQL = "SELECT * FROM(SELECT COMPRA, VENTA FROM " + esquema + "TIPOCAMBIO ORDER BY ORDEN DESC) WHERE ROWNUM = 1";
            resultado = ejecutarComandoSQL(comandoSQL, true);
            return resultado;
        }
    }
