...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset id= "FieldsetBotonesUsuarios" class="fieldset" runat="server" visible="false">
        ...
        <button runat="server" type="button" class="btn btn-info-fozkr" id="botonModificarUsuario" onserverclick="botonModificarUsuario_ServerClick" disabled="disabled" >Modificar usuario</button>
    </fieldset>
    <br />
